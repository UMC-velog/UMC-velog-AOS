...
class SearchAdapter(private val context: Context, private val postList: List<SearchResponse>)
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        ...
        val dateComment = "${outputFormat.format(parsedDate)} ${currentPost.commentsCount}개의 댓글"
